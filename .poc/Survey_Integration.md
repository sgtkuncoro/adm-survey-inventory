# ShopperArmy Survey API Integration
...
*   **Household Language:** 1 = English only, 2=Spanish only, 3=Both equally...
...
### High-Level Requirements (to be detailed later)
  ...
  "quotas": [
    {
      ...
      "completes": 12,
      "qualifications": [
        {"id": "age", "response_ids": ["18","19"..."34"]},
        {"id": "gender", "response_ids": ["1"]},
        {"id": "household_language", "response_ids": ["1"]}
      ]
    }
  ]
}
...
| :--- | :--- | :--- |
| **Phase 1** | API connection + DB + Admin UI | 2-3 weeks |
| **Phase 2** | Auto-deploy + User matching + Tracking | 4-6 weeks |

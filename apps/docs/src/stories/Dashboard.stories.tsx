...
export function TopNavbar() {
  return (
    <header className="border-border sticky top-0 z-50 flex h-14 shrink-0 items-center gap-2 border-b bg-white shadow-sm">
      <div className="flex items-center gap-2 px-3">
        <SidebarTrigger />
      </div>

      <div className="ml-auto flex items-center gap-3 px-4">{/*  */}</div>
    </header>
  );
}
...
function AppSidebar({ isLoading, ...props }: AppSidebarProps) {
  const [activeItem, setActiveItem] = React.useState("Survey Inventory");
  ...
  // Force skeleton during SSR/hydration to avoid mismatch,
  // and while loading user data.
        ...
        <SidebarMenu>
          <SidebarMenuItem>
            <SidebarMenuButton size="lg" asChild>
              <a href="#">
                <div className="flex aspect-square size-8 items-center justify-center rounded-lg bg-sidebar-primary text-sidebar-primary-foreground group-data-[collapsible=icon]:size-4!">
                  <div className="flex h-6 w-6 items-center justify-center rounded-md bg-pink-600 font-bold text-white group-data-[collapsible=icon]:size-3">
                    SA
                  </div>
                </div>
                <div className="grid flex-1 text-left text-sm leading-tight group-data-[collapsible=icon]:hidden">
                  <span className="truncate font-semibold">ShopperArmy</span>
      ...
      <SidebarContent>
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              ...
              <SidebarMenuItem>
                <SidebarMenuButton
                  isActive={activeItem === "Survey Inventory"}
                  onClick={() => setActiveItem("Survey Inventory")}
                  tooltip="Survey Inventory"
                >
                  <LayoutDashboard />
        ...
        <SidebarGroup>
          ...
          <SidebarGroupContent>
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="API Providers">
                  <Plug />
                  <span>API Providers</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton tooltip="Qualification Legend">
                  <FileText />
            ...
            <SidebarMenu>
              <SidebarMenuItem>
                <SidebarMenuButton size="sm" tooltip="Support">
                  <Activity className="text-sidebar-foreground/70" />
                  <span>Support</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
              <SidebarMenuItem>
                <SidebarMenuButton size="sm" tooltip="Feedback">
                  <RotateCw className="text-sidebar-foreground/70" />
                  <span>Feedback</span>
                </SidebarMenuButton>
              </SidebarMenuItem>
            </SidebarMenu>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-gray-500 mt-1">
                    External survey opportunities from API providers
                  </p>
                </div>
              </div>
              ...
              <CardContent className="p-0">
                      ...
                      {surveys.map((survey) => (
                        <React.Fragment key={survey.id}>
                          ...
                          >
                            ...
                            <TableCell
                              className={`font-bold ${survey.closed ? "text-gray-500" : "text-green-600"}`}
                            >
                              {survey.cpi}
                            </TableCell>
                            <TableCell>
                            ...
                            <TableCell className="w-[180px]">
                              <div className="flex items-center gap-3">
                                <Progress
                                  ...
                                  className={`h-1.5 ${survey.closed ? "bg-gray-400" : "bg-gray-100"}`}
                                  indicatorClassName={
                                    survey.closed
                                      ? "bg-gray-500"
                                      : "bg-green-500"
                            ...
                            <TableCell>
                              <span
                                className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${survey.closed ? "bg-gray-200 text-gray-600" : "bg-green-100 text-green-700"}`}
                              >
                                {survey.status}
                              </span>
                            </TableCell>
                            ...
                            <TableCell>
                              <ChevronRight
                                className={`h-4 w-4 text-gray-400 transition-transform ${expandedRow === survey.id ? "rotate-90" : ""}`}
                              />
                            </TableCell>
                          </TableRow>
                                ...
                                <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm animate-in fade-in zoom-in-95 duration-200">
                                  ...
                                  <div className="overflow-x-auto">
                                    <Table>
                                      <TableHeader className="[&_tr]:border-b-gray-100">
                                        <TableRow className="hover:bg-transparent">
                                          <TableHead className="py-2 px-3 text-xs font-semibold text-gray-500">
                                            Quota ID
                                          </TableHead>
                                          <TableHead className="py-2 px-3 text-xs font-semibold text-gray-500">
                                            Gender
                                      ...
                                      <TableBody className="[&_tr]:border-b-gray-50">
                                        <TableRow className="border-b border-gray-50 hover:bg-transparent">
                                          <TableCell className="py-2 px-3 font-mono text-xs text-gray-500">
                                            quota-1
                                          </TableCell>
                                          ...
                                          <TableCell className="py-2 px-3 text-green-600 font-semibold text-xs">
                                            $3.50
                                          </TableCell>
                                          <TableCell className="py-2 px-3 text-gray-700 text-xs">
                                            250
                                        ...
                                        <TableRow className="hover:bg-transparent">
                                          <TableCell
                                            colSpan={8}
                                            className="py-2 px-3 text-center text-gray-500 text-xs italic"
                                          >
                                            + 11 more quotas...
                                          </TableCell>
                                        </TableRow>
                ...
                <div className="px-6 py-4 border-t border-gray-100 flex items-center justify-between">
                  <div className="text-sm text-gray-500">
                    Showing{" "}
                    <span className="font-medium text-gray-900">1-6</span> of{" "}

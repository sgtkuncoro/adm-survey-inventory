...
This skill uses the shared package \`@packages/supabase\` to manage Supabase clients, ensuring consistent type safety and configuration across the monorepo (Workers + Next.js).
